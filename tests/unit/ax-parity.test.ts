  ...
  test('every AX operation is wired across SDK, HTTP, MCP, CLI, and CanvasAccess', () => {
    ...
    const ops: Array<{
      ...
      },
      {
        ...
        cliCommand: "'ax approval request',",
      ...
      },
      {
        ...
        cliCommand: "'ax approval resolve',",
      ...
      },
      {
        ...
        cliCommand: "'ax elicitation request',",
