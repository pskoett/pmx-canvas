...
The examples pin **PMX Canvas 0.6.3**, which requires **Bun >=1.4.2** even when
...
Without a global install, use `bunx pmx-canvas@0.6.3` in place of `pmx-canvas` in
