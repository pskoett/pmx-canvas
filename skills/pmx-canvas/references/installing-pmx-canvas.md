...
The examples pin **PMX Canvas 0.5.1**, which requires **Bun >=1.3.14** even when
...
Without a global install, use `bunx pmx-canvas@0.5.1` in place of `pmx-canvas` in
...
This uses the checked-out source, not necessarily the published 0.5.1 package. Follow
